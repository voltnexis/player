...
export const ControlsBar: React.FC<ControlsBarProps> = ({
  ...
  return (
    <div className={`absolute bottom-0 left-0 right-0 px-4 pb-4 pt-16 bg-gradient-to-t from-black/95 via-black/50 to-transparent transition-opacity duration-300 z-10 
      ...
      <div className="flex items-center justify-between mt-2">
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <div className="text-[11px] sm:text-sm font-medium tracking-wide text-zinc-300">
            {formatTime(state.currentTime)} <span className="text-zinc-500 mx-0.5">/</span> {formatTime(state.duration)}
          </div>
        </div>
